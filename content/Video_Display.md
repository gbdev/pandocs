...
1.1\.  [LCD Control Register](#lcdcontrolregister)  
1.2\.  [LCD Status Register](#lcdstatusregister)  
1.2.0.1\.  [FF41 - STAT - LCDC Status (R/W)](#ff41-stat-lcdcstatusr/w)  
1.3\.  [LCD Interrupts](#lcdinterrupts)  
1.3.0.1\.  [INT 40 - V-Blank Interrupt](#int40-v-blankinterrupt)  
1.3.0.2\.  [INT 48 - LCDC Status Interrupt](#int48-lcdcstatusinterrupt)  
1.4\.  [LCD Position and Scrolling](#lcdpositionandscrolling)  
1.4.0.1\.  [FF42 - SCY - Scroll Y (R/W), FF43 - SCX - Scroll X (R/W)](#ff42-scy-scrollyr/wff43-scx-scrollxr/w)  
1.4.0.2\.  [FF44 - LY - LCDC Y-Coordinate (R)](#ff44-ly-lcdcy-coordinater)  
1.4.0.3\.  [FF45 - LYC - LY Compare (R/W)](#ff45-lyc-lycomparer/w)  
1.4.0.4\.  [FF4A - WY - Window Y Position (R/W), FF4B - WX - Window X Position minus 7 (R/W)](#ff4a-wy-windowypositionr/wff4b-wx-windowxpositionminus7r/w)  
1.5\.  [LCD Monochrome Palettes](#lcdmonochromepalettes)  
1.5.0.1\.  [FF47 - BGP - BG Palette Data (R/W) - Non CGB Mode Only](#ff47-bgp-bgpalettedatar/w-noncgbmodeonly)  
1.5.0.2\.  [FF48 - OBP0 - Object Palette 0 Data (R/W) - Non CGB Mode Only](#ff48-obp0-objectpalette0datar/w-noncgbmodeonly)  
1.5.0.3\.  [FF49 - OBP1 - Object Palette 1 Data (R/W) - Non CGB Mode Only](#ff49-obp1-objectpalette1datar/w-noncgbmodeonly)  
1.6\.  [LCD Color Palettes (CGB only)](#lcdcolorpalettescgbonly)  
1.6.0.1\.  [FF68 - BCPS/BGPI - CGB Mode Only - Background Palette Index](#ff68-bcps/bgpi-cgbmodeonly-backgroundpaletteindex)  
1.6.0.2\.  [FF69 - BCPD/BGPD - CGB Mode Only - Background Palette Data](#ff69-bcpd/bgpd-cgbmodeonly-backgroundpalettedata)  
1.6.0.3\.  [FF6A - OCPS/OBPI - CGB Mode Only - Sprite Palette Index, FF6B - OCPD/OBPD - CGB Mode Only - Sprite Palette Data](#ff6a-ocps/obpi-cgbmodeonly-spritepaletteindexff6b-ocpd/obpd-cgbmodeonly-spritepalettedata)  
1.6.0.4\.  [RGB Translation by CGBs](#rgbtranslationbycgbs)  
1.6.0.5\.  [RGB Translation by GBAs](#rgbtranslationbygbas)  
1.7\.  [LCD OAM DMA Transfers](#lcdoamdmatransfers)  
1.7.0.1\.  [FF46 - DMA - DMA Transfer and Start Address (R/W)](#ff46-dma-dmatransferandstartaddressr/w)  
1.8\.  [LCD VRAM DMA Transfers (CGB only)](#lcdvramdmatransferscgbonly)  
1.8.0.1\.  [FF51 - HDMA1 - CGB Mode Only - New DMA Source, High](#ff51-hdma1-cgbmodeonly-newdmasourcehigh)  
1.8.0.2\.  [FF52 - HDMA2 - CGB Mode Only - New DMA Source, Low](#ff52-hdma2-cgbmodeonly-newdmasourcelow)  
1.8.0.3\.  [FF53 - HDMA3 - CGB Mode Only - New DMA Destination, High](#ff53-hdma3-cgbmodeonly-newdmadestinationhigh)  
1.8.0.4\.  [FF54 - HDMA4 - CGB Mode Only - New DMA Destination, Low](#ff54-hdma4-cgbmodeonly-newdmadestinationlow)  
1.8.0.5\.  [FF55 - HDMA5 - CGB Mode Only - New DMA Length/Mode/Start](#ff55-hdma5-cgbmodeonly-newdmalength/mode/start)  
1.8.0.5.1\.  [Bit7=0 - General Purpose DMA](#bit7=0-generalpurposedma)  
1.8.0.5.2\.  [Bit7=1 - H-Blank DMA](#bit7=1-h-blankdma)  
1.8.0.6\.  [Precautions](#precautions)  
1.8.0.7\.  [Confirming if the DMA Transfer is Active](#confirmingifthedmatransferisactive)  
1.8.0.8\.  [Transfer Timings](#transfertimings)  
1.9\.  [VRAM Tile Data](#vramtiledata)  
1.10\.  [VRAM Background Maps](#vrambackgroundmaps)  
1.10.0.1\.  [BG Map Tile Numbers](#bgmaptilenumbers)  
1.10.0.2\.  [BG Map Attributes (CGB Mode only)](#bgmapattributescgbmodeonly)  
1.10.0.3\.  [Normal Background (BG)](#normalbackgroundbg)  
1.10.0.4\.  [The Window](#thewindow)  
1.11\.  [VRAM Banks (CGB only)](#vrambankscgbonly)  
1.11.0.1\.  [FF4F - VBK - CGB Mode Only - VRAM Bank (R/W)](#ff4f-vbk-cgbmodeonly-vrambankr/w)  
1.11.0.2\.  [VRAM bank 1](#vrambank1)  
1.12\.  [VRAM Sprite Attribute Table (OAM)](#vramspriteattributetableoam)  
1.12.0.1\.  [Byte0 - Y Position](#byte0-yposition)  
1.12.0.2\.  [Byte1 - X Position](#byte1-xposition)  
1.12.0.3\.  [Byte2 - Tile/Pattern Number](#byte2-tile/patternnumber)  
1.12.0.4\.  [Byte3 - Attributes/Flags:](#byte3-attributes/flags:)  
1.12.0.5\.  [Sprite Priorities and Conflicts](#spriteprioritiesandconflicts)  
1.12.0.6\.  [Writing Data to OAM Memory](#writingdatatooammemory)  
1.13\.  [Accessing VRAM and OAM](#accessingvramandoam)  
1.13.0.1\.  [CAUTION](#caution)  
1.13.0.2\.  [VRAM (memory at 8000h-9FFFh) is accessible during Mode 0-2](#vrammemoryat8000h-9fffhisaccessibleduringmode0-2)  
1.13.0.3\.  [OAM (memory at FE00h-FE9Fh) is accessible during Mode 0-1](#oammemoryatfe00h-fe9fhisaccessibleduringmode0-1)  
1.13.0.4\.  [Note](#note)  
1.14\.  [CPU Specifications](#cpuspecifications)  
1.15\.  [Cartridges](#cartridges)  
1.16\.  [Other](#other)  

<a name="videodisplay"></a>

# 1\. Video Display

<a name="lcdcontrolregister"></a>

## 1.1\. LCD Control Register
...
<a name="lcdstatusregister"></a>

## 1.2\. LCD Status Register

<a name="ff41-stat-lcdcstatusr/w"></a>

#### 1.2.0.1\. FF41 - STAT - LCDC Status (R/W)
...
<a name="lcdinterrupts"></a>

## 1.3\. LCD Interrupts

<a name="int40-v-blankinterrupt"></a>

#### 1.3.0.1\. INT 40 - V-Blank Interrupt
...
<a name="int48-lcdcstatusinterrupt"></a>

#### 1.3.0.2\. INT 48 - LCDC Status Interrupt
...
<a name="lcdpositionandscrolling"></a>

## 1.4\. LCD Position and Scrolling

These registers can be accessed even during Mode 3, but they have no
effect until the end of the current scanline.

<a name="ff42-scy-scrollyr/wff43-scx-scrollxr/w"></a>

#### 1.4.0.1\. FF42 - SCY - Scroll Y (R/W), FF43 - SCX - Scroll X (R/W)
...
<a name="ff44-ly-lcdcy-coordinater"></a>

#### 1.4.0.2\. FF44 - LY - LCDC Y-Coordinate (R)
...
<a name="ff45-lyc-lycomparer/w"></a>

#### 1.4.0.3\. FF45 - LYC - LY Compare (R/W)
...
<a name="ff4a-wy-windowypositionr/wff4b-wx-windowxpositionminus7r/w"></a>

#### 1.4.0.4\. FF4A - WY - Window Y Position (R/W), FF4B - WX - Window X Position minus 7 (R/W)
...
<a name="lcdmonochromepalettes"></a>

## 1.5\. LCD Monochrome Palettes

<a name="ff47-bgp-bgpalettedatar/w-noncgbmodeonly"></a>

#### 1.5.0.1\. FF47 - BGP - BG Palette Data (R/W) - Non CGB Mode Only
...
<a name="ff48-obp0-objectpalette0datar/w-noncgbmodeonly"></a>

#### 1.5.0.2\. FF48 - OBP0 - Object Palette 0 Data (R/W) - Non CGB Mode Only
...
<a name="ff49-obp1-objectpalette1datar/w-noncgbmodeonly"></a>

#### 1.5.0.3\. FF49 - OBP1 - Object Palette 1 Data (R/W) - Non CGB Mode Only

This register assigns gray shades for sprite palette 1. It works exactly
as BGP (FF47), except that the lower two bits aren't used because
sprite data 00 is transparent.

<a name="lcdcolorpalettescgbonly"></a>

## 1.6\. LCD Color Palettes (CGB only)

<a name="ff68-bcps/bgpi-cgbmodeonly-backgroundpaletteindex"></a>

#### 1.6.0.1\. FF68 - BCPS/BGPI - CGB Mode Only - Background Palette Index
...
<a name="ff69-bcpd/bgpd-cgbmodeonly-backgroundpalettedata"></a>

#### 1.6.0.2\. FF69 - BCPD/BGPD - CGB Mode Only - Background Palette Data
...
<a name="ff6a-ocps/obpi-cgbmodeonly-spritepaletteindexff6b-ocpd/obpd-cgbmodeonly-spritepalettedata"></a>

#### 1.6.0.3\. FF6A - OCPS/OBPI - CGB Mode Only - Sprite Palette Index, FF6B - OCPD/OBPD - CGB Mode Only - Sprite Palette Data
...
<a name="rgbtranslationbycgbs"></a>

#### 1.6.0.4\. RGB Translation by CGBs
...
<a name="rgbtranslationbygbas"></a>

#### 1.6.0.5\. RGB Translation by GBAs
...
<a name="lcdoamdmatransfers"></a>

## 1.7\. LCD OAM DMA Transfers

<a name="ff46-dma-dmatransferandstartaddressr/w"></a>

#### 1.7.0.1\. FF46 - DMA - DMA Transfer and Start Address (R/W)
...
<a name="lcdvramdmatransferscgbonly"></a>

## 1.8\. LCD VRAM DMA Transfers (CGB only)

<a name="ff51-hdma1-cgbmodeonly-newdmasourcehigh"></a>

#### 1.8.0.1\. FF51 - HDMA1 - CGB Mode Only - New DMA Source, High

<a name="ff52-hdma2-cgbmodeonly-newdmasourcelow"></a>

#### 1.8.0.2\. FF52 - HDMA2 - CGB Mode Only - New DMA Source, Low
...
<a name="ff53-hdma3-cgbmodeonly-newdmadestinationhigh"></a>

#### 1.8.0.3\. FF53 - HDMA3 - CGB Mode Only - New DMA Destination, High

<a name="ff54-hdma4-cgbmodeonly-newdmadestinationlow"></a>

#### 1.8.0.4\. FF54 - HDMA4 - CGB Mode Only - New DMA Destination, Low
...
<a name="ff55-hdma5-cgbmodeonly-newdmalength/mode/start"></a>

#### 1.8.0.5\. FF55 - HDMA5 - CGB Mode Only - New DMA Length/Mode/Start
...
<a name="bit7=0-generalpurposedma"></a>

##### 1.8.0.5.1\. Bit7=0 - General Purpose DMA
...
<a name="bit7=1-h-blankdma"></a>

##### 1.8.0.5.2\. Bit7=1 - H-Blank DMA
...
<a name="confirmingifthedmatransferisactive"></a>

#### 1.8.0.7\. Confirming if the DMA Transfer is Active
...
<a name="transfertimings"></a>

#### 1.8.0.8\. Transfer Timings
...
<a name="vrambackgroundmaps"></a>

## 1.10\. VRAM Background Maps
...
<a name="bgmaptilenumbers"></a>

#### 1.10.0.1\. BG Map Tile Numbers
...
<a name="bgmapattributescgbmodeonly"></a>

#### 1.10.0.2\. BG Map Attributes (CGB Mode only)
...
<a name="normalbackgroundbg"></a>

#### 1.10.0.3\. Normal Background (BG)
...
<a name="vrambankscgbonly"></a>

## 1.11\. VRAM Banks (CGB only)

The CGB has twice the VRAM of the DMG, but it is banked and either bank
has a different purpose.

<a name="ff4f-vbk-cgbmodeonly-vrambankr/w"></a>

#### 1.11.0.1\. FF4F - VBK - CGB Mode Only - VRAM Bank (R/W)
...
<a name="vramspriteattributetableoam"></a>

## 1.12\. VRAM Sprite Attribute Table (OAM)
...
<a name="byte0-yposition"></a>

#### 1.12.0.1\. Byte0 - Y Position
...
<a name="byte1-xposition"></a>

#### 1.12.0.2\. Byte1 - X Position
...
<a name="byte2-tile/patternnumber"></a>

#### 1.12.0.3\. Byte2 - Tile/Pattern Number
...
<a name="byte3-attributes/flags:"></a>

#### 1.12.0.4\. Byte3 - Attributes/Flags:
...
<a name="spriteprioritiesandconflicts"></a>

#### 1.12.0.5\. Sprite Priorities and Conflicts
...
<a name="writingdatatooammemory"></a>

#### 1.12.0.6\. Writing Data to OAM Memory
...
<a name="accessingvramandoam"></a>

## 1.13\. Accessing VRAM and OAM
...
<a name="vrammemoryat8000h-9fffhisaccessibleduringmode0-2"></a>

#### 1.13.0.2\. VRAM (memory at 8000h-9FFFh) is accessible during Mode 0-2
...
<a name="oammemoryatfe00h-fe9fhisaccessibleduringmode0-1"></a>

#### 1.13.0.3\. OAM (memory at FE00h-FE9Fh) is accessible during Mode 0-1
...
<div align="center"> Properties of STAT modes </div>
