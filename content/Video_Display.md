...
The LY indicates the horizontal line to which the present data is
transferred to the LCD Driver. The LY can take on any value from 0
to 153. The values from 144 to 153 indicate the VBlank period.
