...
::: tip NOTE
Select the clock frequency first, then enable the Timer. Starting the Timer before
or at the same time as the clock frequency is selected may result in excessive count up operation.
